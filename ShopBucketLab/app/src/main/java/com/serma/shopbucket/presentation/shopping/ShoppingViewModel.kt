...
class ShoppingViewModel @Inject constructor(
    ...
    private val _purchase: MutableLiveData<Response<Purchase>> =
        MutableLiveData()
    val purchase: LiveData<Response<Purchase>> = _purchase
    ...
    fun deleteShopping(
        ...
        val disposable = deleteShoppingUseCase(idPurchase, idShopping, itemPrice, count, complete)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe { result ->
